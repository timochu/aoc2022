...
rucksacks
|> Array.sumBy (Seq.splitInto 2 >> Seq.map set >> Set.intersectMany >> Seq.head >> priority.IndexOf)
|> printfn "Part 1: %i"

rucksacks
|> Array.chunkBySize 3
|> Array.sumBy (Array.map set >> Set.intersectMany >> Seq.head >> priority.IndexOf)
|> printfn "Part 2: %i"