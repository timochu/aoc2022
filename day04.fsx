...
let pairings = 
    ...
    |> Array.map (fun s -> s.Split(',', '-') |> Array.map int |> fun [| a1; a2; b1; b2 |] -> Set [a1..a2], Set [b1..b2])

printfn "Part 1: %A" (pairings |> Array.countBy (fun (p1, p2) -> Set.isSubset p1 p2 || Set.isSuperset p1 p2))
